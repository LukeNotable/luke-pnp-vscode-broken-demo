...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$)|(^(?:foo(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$)|(^(?:bar(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$)",
    ...
    "packageRegistryData": [
      ...
      ["query-string", [
        ["npm:6.3.0", {
          "packageLocation": "./.yarn/cache/query-string-npm-6.3.0-60b79515fa-29f23c70c4.zip/node_modules/query-string/",
          "packageDependencies": [
            ["query-string", "npm:6.3.0"],
            ["decode-uri-component", "npm:0.2.0"],
